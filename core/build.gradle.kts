...
project.ext.set("loom.platform", stonecutter.modPlatform)
...
val generateAssets by tasks.registering(GenerateAssetsTask::class) {
    ...
    assetsDirectory.set(rootProject.file("core/src/main/resources/assets"))
...
val generateLang by tasks.registering(GenerateLangTask::class) {
    generatedPackage.set("ru.hollowhorizon.hollowengine.generated")
    langDirectory.set(rootProject.file("core/src/main/resources/assets/hollowengine/lang"))
